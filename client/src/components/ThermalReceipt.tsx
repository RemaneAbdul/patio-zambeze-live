...
export function ThermalReceipt({ selections, total, width = "58mm", language = "pt", className = "" }: { selections: ReceiptSelection[]; total: number; width?: "58mm" | "80mm"; language?: "pt" | "en"; className?: string }) {

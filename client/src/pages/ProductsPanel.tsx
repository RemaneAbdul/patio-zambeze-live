...
const emptyForm = { name: "", nameEn: "", categoryId: "", price: "", description: "", descriptionEn: "", preparation: "", preparationEn: "", imageUrl: "" };
...
export default function ProductsPanel() {
  ...
  const startEdit = (entry: NonNullable<typeof products.data>[number]) => { setEditingId(entry.product.id); setForm({ name: entry.product.name, nameEn: entry.product.nameEn ?? "", categoryId: String(entry.product.categoryId), price: String(entry.product.price), description: entry.product.description ?? "", descriptionEn: entry.product.descriptionEn ?? "", preparation: entry.product.preparation ?? "", preparationEn: entry.product.preparationEn ?? "", imageUrl: entry.product.imageUrl ?? "" }); window.scrollTo({ top: 0, behavior: "smooth" }); };
  ...
  const save = () => {
    ...
    const input = { categoryId: Number(form.categoryId), name: form.name.trim(), nameEn: form.nameEn || undefined, price: numericPrice, description: form.description || undefined, descriptionEn: form.descriptionEn || undefined, preparation: form.preparation || undefined, preparationEn: form.preparationEn || undefined, imageUrl: form.imageUrl || undefined };

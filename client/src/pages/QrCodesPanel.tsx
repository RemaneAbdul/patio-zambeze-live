...
export default function QrCodesPanel() {
  ...
  const customerUrl = selected ? `${window.location.origin}/?mesa=${encodeURIComponent(selected.tableNumber)}&qr=${encodeURIComponent(selected.qrToken)}` : "";

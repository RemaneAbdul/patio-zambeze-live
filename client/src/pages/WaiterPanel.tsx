...
import { ArrowLeft, CheckCircle2, Circle, Eye, LockKeyhole, Plus, Printer, RefreshCw, Search, Trash2, X } from "lucide-react";
...
export default function WaiterPanel() {
  ...
  const createManualOrder = trpc.tableHistory.createManualOrder.useMutation({ onSuccess: async () => { setManualOpen(false); setManualTableId(""); setManualCategory(""); setManualProductId(""); setManualItems([]); setManualNotes(""); await Promise.all([utils.tableHistory.staffTables.invalidate(), qrCodes.refetch()]); } });

...
function mapPanelActionError(error: unknown): string {
  ...
  if (/ADMIN_EMAIL_ALREADY_EXISTS|email já está registado/i.test(raw)) return "Este email já está registado. Use outro email.";
